...
namespace PokemonDebugTags
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navigation);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navigation_Request);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navigation_Projection);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Navigation_Path);
