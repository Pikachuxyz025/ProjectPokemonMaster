...
#include "MyInputTriggerComboAction.generated.h"

using namespace UP;
/**
 * 
 */
UCLASS(NotBlueprintable, meta = (DisplayName = "Axis Value Combo", NotInputConfigurable = "true"))
class PROJECTMIMIKYU_API UMyInputTriggerComboAction : public UInputTrigger
{
	GENERATED_BODY()
	
public:
	UMyInputTriggerComboAction();
...
protected:
	...
	TObjectPtr<const UInputAction> RecordableAction;

	FInputActionValue ReacordedActionValue;
public:
