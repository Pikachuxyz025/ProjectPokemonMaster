...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPokemonDebugWorldSubsystem_Statics::NewProp_RecentMessages_Inner = { "RecentMessages", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FPokemonDebugMessage, METADATA_PARAMS(0, nullptr) }; // 3217748962
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPokemonDebugWorldSubsystem_Statics::NewProp_RecentMessages = { "RecentMessages", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UPokemonDebugWorldSubsystem, RecentMessages), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RecentMessages_MetaData), NewProp_RecentMessages_MetaData) }; // 3217748962
...
struct Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_Debugging_PokemonDebugWorldSubsystem_h__Script_ProjectMimikyu_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPokemonDebugWorldSubsystem, UPokemonDebugWorldSubsystem::StaticClass, TEXT("UPokemonDebugWorldSubsystem"), &Z_Registration_Info_UClass_UPokemonDebugWorldSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPokemonDebugWorldSubsystem), 1105250941U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_Debugging_PokemonDebugWorldSubsystem_h__Script_ProjectMimikyu_1386506446{
