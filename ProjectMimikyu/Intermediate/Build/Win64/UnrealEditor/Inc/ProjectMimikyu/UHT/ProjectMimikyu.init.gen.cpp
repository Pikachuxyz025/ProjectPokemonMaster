...
void EmptyLinkFunctionForGeneratedCodeProjectMimikyu_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_ProjectMimikyu()
	{
		if (!Z_Registration_Info_UPackage__Script_ProjectMimikyu.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_ProjectMimikyu_OnPokemonHealthUpdated__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_ProjectMimikyu(Z_Construct_UPackage__Script_ProjectMimikyu, TEXT("/Script/ProjectMimikyu"), Z_Registration_Info_UPackage__Script_ProjectMimikyu, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x7964FA59, 0x6717DE45));
