...
struct Z_Construct_UClass_UDamageInterface_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UDamageInterface_HasFainted, "HasFainted" }, // 40326617
		{ &Z_Construct_UFunction_UDamageInterface_IsAttacking, "IsAttacking" }, // 412675298
		{ &Z_Construct_UFunction_UDamageInterface_RecieveHealth, "RecieveHealth" }, // 2621439937
	};
...
struct Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_Interfaces_DamageInterface_h__Script_ProjectMimikyu_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDamageInterface, UDamageInterface::StaticClass, TEXT("UDamageInterface"), &Z_Registration_Info_UClass_UDamageInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDamageInterface), 355724057U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_Interfaces_DamageInterface_h__Script_ProjectMimikyu_1239392994(TEXT("/Script/ProjectMimikyu"),
