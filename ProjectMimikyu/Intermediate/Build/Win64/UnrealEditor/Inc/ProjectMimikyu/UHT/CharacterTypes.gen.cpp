...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EGenderType>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EPartyStatus>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EMovementSpeed>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EElementalType>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<ENatureType>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EStatsType>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EStatusType>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EPokemonStatus>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EProjectileEffect>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EMoveAction>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EDamageResponse>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EDirectionPoint>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EMoveType>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EPokeballType>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<ESlotType>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EPokemonState>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EEnvironmentLandingPattern>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EEnvironmentSpawnHeightMode>()
{
...
template<> PROJECTMIMIKYU_NON_ATTRIBUTED_API UEnum* StaticEnum<EEnvironmentFallDirection>()
{
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FPokemonTypeInfo); }
	static inline consteval int16 GetStructAlignment() { return alignof(FPokemonTypeInfo); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FPokemonTypeInfo constinit property declarations ******************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FPokemonTypeInfo constinit property declarations ********************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FPokemonTypeInfo Property Definitions *****************************
...
// ********** End ScriptStruct FPokemonTypeInfo Property Definitions *******************************
...
UScriptStruct* Z_Construct_UScriptStruct_FPokemonTypeInfo()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FPokemonTypeInfo.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FPokemonMoveChart); }
	static inline consteval int16 GetStructAlignment() { return alignof(FPokemonMoveChart); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FPokemonMoveChart constinit property declarations *****************
// ********** End ScriptStruct FPokemonMoveChart constinit property declarations *******************
	static void* NewStructOps()
	{
...
UScriptStruct* Z_Construct_UScriptStruct_FPokemonMoveChart()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FPokemonMoveChart.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FProjectileTagContainer); }
	static inline consteval int16 GetStructAlignment() { return alignof(FProjectileTagContainer); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FProjectileTagContainer constinit property declarations ***********
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FProjectileTagContainer constinit property declarations *************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FProjectileTagContainer Property Definitions **********************
...
// ********** End ScriptStruct FProjectileTagContainer Property Definitions ************************
...
UScriptStruct* Z_Construct_UScriptStruct_FProjectileTagContainer()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FProjectileTagContainer.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FEnvironmentDropParams); }
	static inline consteval int16 GetStructAlignment() { return alignof(FEnvironmentDropParams); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FEnvironmentDropParams constinit property declarations ************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FEnvironmentDropParams constinit property declarations **************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FEnvironmentDropParams Property Definitions ***********************
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEnvironmentDropParams_Statics::NewProp_AreaRadius = { "AreaRadius", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvironmentDropParams, AreaRadius), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AreaRadius_MetaData), NewProp_AreaRadius_MetaData) };
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FEnvironmentDropParams_Statics::NewProp_LandingPattern = { "LandingPattern", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvironmentDropParams, LandingPattern), Z_Construct_UEnum_ProjectMimikyu_EEnvironmentLandingPattern, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LandingPattern_MetaData), NewProp_LandingPattern_MetaData) }; // 4256400058
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FEnvironmentDropParams_Statics::NewProp_NumProjectiles = { "NumProjectiles", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvironmentDropParams, NumProjectiles), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NumProjectiles_MetaData), NewProp_NumProjectiles_MetaData) };
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FEnvironmentDropParams_Statics::NewProp_NumWaves = { "NumWaves", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvironmentDropParams, NumWaves), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_NumWaves_MetaData), NewProp_NumWaves_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEnvironmentDropParams_Statics::NewProp_TimeBetweenWaves = { "TimeBetweenWaves", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvironmentDropParams, TimeBetweenWaves), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TimeBetweenWaves_MetaData), NewProp_TimeBetweenWaves_MetaData) };
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FEnvironmentDropParams_Statics::NewProp_SpawnHeightMode = { "SpawnHeightMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvironmentDropParams, SpawnHeightMode), Z_Construct_UEnum_ProjectMimikyu_EEnvironmentSpawnHeightMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SpawnHeightMode_MetaData), NewProp_SpawnHeightMode_MetaData) }; // 1280782785
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEnvironmentDropParams_Statics::NewProp_SpawnHeight = { "SpawnHeight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvironmentDropParams, SpawnHeight), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SpawnHeight_MetaData), NewProp_SpawnHeight_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEnvironmentDropParams_Statics::NewProp_InitialSpeed = { "InitialSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FEnvironmentDropParams, InitialSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InitialSpeed_MetaData), NewProp_InitialSpeed_MetaData) };
...
// ********** End ScriptStruct FEnvironmentDropParams Property Definitions *************************
...
UScriptStruct* Z_Construct_UScriptStruct_FEnvironmentDropParams()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FEnvironmentDropParams.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FTypeChartMatchup); }
	static inline consteval int16 GetStructAlignment() { return alignof(FTypeChartMatchup); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FTypeChartMatchup constinit property declarations *****************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FTypeChartMatchup constinit property declarations *******************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FTypeChartMatchup Property Definitions ****************************
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FTypeChartMatchup_Statics::NewProp_TypeResponse_Key_KeyProp = { "TypeResponse_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UEnum_ProjectMimikyu_EElementalType, METADATA_PARAMS(0, nullptr) }; // 1457640518
const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FTypeChartMatchup_Statics::NewProp_TypeResponse = { "TypeResponse", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FTypeChartMatchup, TypeResponse), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_TypeResponse_MetaData), NewProp_TypeResponse_MetaData) }; // 1457640518
...
// ********** End ScriptStruct FTypeChartMatchup Property Definitions ******************************
...
UScriptStruct* Z_Construct_UScriptStruct_FTypeChartMatchup()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FTypeChartMatchup.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FPokemonUIInfo); }
	static inline consteval int16 GetStructAlignment() { return alignof(FPokemonUIInfo); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
// ********** Begin ScriptStruct FPokemonUIInfo constinit property declarations ********************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FPokemonUIInfo constinit property declarations **********************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FPokemonUIInfo Property Definitions *******************************
...
// ********** End ScriptStruct FPokemonUIInfo Property Definitions *********************************
...
UScriptStruct* Z_Construct_UScriptStruct_FPokemonUIInfo()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FPokemonUIInfo.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FPokemonInfo); }
	static inline consteval int16 GetStructAlignment() { return alignof(FPokemonInfo); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "IsBlueprintBase", "true" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CapturedBallClass_MetaData[] = {
		{ "Category", "PokemonInfo" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
	};
...
// ********** Begin ScriptStruct FPokemonInfo constinit property declarations **********************
	...
	static const UECodeGen_Private::FClassPropertyParams NewProp_CapturedBallClass;
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FPokemonInfo constinit property declarations ************************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FPokemonInfo Property Definitions *********************************
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FPokemonInfo_Statics::NewProp_CapturedBallClass = { "CapturedBallClass", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPokemonInfo, CapturedBallClass), Z_Construct_UClass_UClass_NoRegister, Z_Construct_UClass_APokeBall_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CapturedBallClass_MetaData), NewProp_CapturedBallClass_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FPokemonInfo_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPokemonInfo_Statics::NewProp_CapturedBallClass,
...
// ********** End ScriptStruct FPokemonInfo Property Definitions ***********************************
...
UScriptStruct* Z_Construct_UScriptStruct_FPokemonInfo()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FPokemonInfo.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FTagCategoryMap); }
	static inline consteval int16 GetStructAlignment() { return alignof(FTagCategoryMap); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FTagCategoryMap constinit property declarations *******************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FTagCategoryMap constinit property declarations *********************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FTagCategoryMap Property Definitions ******************************
...
// ********** End ScriptStruct FTagCategoryMap Property Definitions ********************************
...
UScriptStruct* Z_Construct_UScriptStruct_FTagCategoryMap()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FTagCategoryMap.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FSequentialShotParams); }
	static inline consteval int16 GetStructAlignment() { return alignof(FSequentialShotParams); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FSequentialShotParams constinit property declarations *************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FSequentialShotParams constinit property declarations ***************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FSequentialShotParams Property Definitions ************************
...
// ********** End ScriptStruct FSequentialShotParams Property Definitions **************************
...
UScriptStruct* Z_Construct_UScriptStruct_FSequentialShotParams()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FSequentialShotParams.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FPokemonParty); }
	static inline consteval int16 GetStructAlignment() { return alignof(FPokemonParty); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FPokemonParty constinit property declarations *********************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FPokemonParty constinit property declarations ***********************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FPokemonParty Property Definitions ********************************
...
// ********** End ScriptStruct FPokemonParty Property Definitions **********************************
...
UScriptStruct* Z_Construct_UScriptStruct_FPokemonParty()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FPokemonParty.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FDamageInfo); }
	static inline consteval int16 GetStructAlignment() { return alignof(FDamageInfo); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FDamageInfo constinit property declarations ***********************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FDamageInfo constinit property declarations *************************
	static void* NewStructOps()
	{
...
// ********** Begin ScriptStruct FDamageInfo Property Definitions **********************************
...
// ********** End ScriptStruct FDamageInfo Property Definitions ************************************
...
UScriptStruct* Z_Construct_UScriptStruct_FDamageInfo()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FDamageInfo.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FInventoryItemInfo); }
	static inline consteval int16 GetStructAlignment() { return alignof(FInventoryItemInfo); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/Characters/CharacterTypes.h" },
...
// ********** Begin ScriptStruct FInventoryItemInfo constinit property declarations ****************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FInventoryItemInfo constinit property declarations ******************
	static void* NewStructOps()
	{
...
// ********** End ScriptStruct FInventoryItemInfo Property Definitions *****************************
...
UScriptStruct* Z_Construct_UScriptStruct_FInventoryItemInfo()
{
	...
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FInventoryItemInfo.InnerSingleton);
}
...
struct Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_Characters_CharacterTypes_h__Script_ProjectMimikyu_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EGenderType_StaticEnum, TEXT("EGenderType"), &Z_Registration_Info_UEnum_EGenderType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3170657478U) },
		{ EPartyStatus_StaticEnum, TEXT("EPartyStatus"), &Z_Registration_Info_UEnum_EPartyStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4229292539U) },
		{ EMovementSpeed_StaticEnum, TEXT("EMovementSpeed"), &Z_Registration_Info_UEnum_EMovementSpeed, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3830158877U) },
		{ EElementalType_StaticEnum, TEXT("EElementalType"), &Z_Registration_Info_UEnum_EElementalType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1457640518U) },
		{ ENatureType_StaticEnum, TEXT("ENatureType"), &Z_Registration_Info_UEnum_ENatureType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1385819911U) },
		{ EStatsType_StaticEnum, TEXT("EStatsType"), &Z_Registration_Info_UEnum_EStatsType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3141137852U) },
		{ EStatusType_StaticEnum, TEXT("EStatusType"), &Z_Registration_Info_UEnum_EStatusType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1528981260U) },
		{ EPokemonStatus_StaticEnum, TEXT("EPokemonStatus"), &Z_Registration_Info_UEnum_EPokemonStatus, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1292692463U) },
		{ EProjectileEffect_StaticEnum, TEXT("EProjectileEffect"), &Z_Registration_Info_UEnum_EProjectileEffect, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2804472495U) },
		{ EMoveAction_StaticEnum, TEXT("EMoveAction"), &Z_Registration_Info_UEnum_EMoveAction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1596998838U) },
		{ EDamageResponse_StaticEnum, TEXT("EDamageResponse"), &Z_Registration_Info_UEnum_EDamageResponse, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 666422384U) },
		...
		{ EEnvironmentSpawnHeightMode_StaticEnum, TEXT("EEnvironmentSpawnHeightMode"), &Z_Registration_Info_UEnum_EEnvironmentSpawnHeightMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1280782785U) },
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FPokemonInfo::StaticStruct, Z_Construct_UScriptStruct_FPokemonInfo_Statics::NewStructOps, TEXT("PokemonInfo"),&Z_Registration_Info_UScriptStruct_FPokemonInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPokemonInfo), 2283151312U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_Characters_CharacterTypes_h__Script_ProjectMimikyu_518824355{
