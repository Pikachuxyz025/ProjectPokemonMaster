...
UScriptStruct* Z_Construct_UScriptStruct_FDamageEffectParams()
{
	...
	return Z_Registration_Info_UScriptStruct_FDamageEffectParams.InnerSingleton;
}
...
UScriptStruct* Z_Construct_UScriptStruct_FPokemonGameplayEffectContext()
{
	...
	return Z_Registration_Info_UScriptStruct_FPokemonGameplayEffectContext.InnerSingleton;
}
...
struct Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_PokemonAbilityTypes_h__Script_ProjectMimikyu_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FDamageEffectParams::StaticStruct, Z_Construct_UScriptStruct_FDamageEffectParams_Statics::NewStructOps, TEXT("DamageEffectParams"), &Z_Registration_Info_UScriptStruct_FDamageEffectParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDamageEffectParams), 2727659433U) },
		{ FPokemonGameplayEffectContext::StaticStruct, Z_Construct_UScriptStruct_FPokemonGameplayEffectContext_Statics::NewStructOps, TEXT("PokemonGameplayEffectContext"), &Z_Registration_Info_UScriptStruct_FPokemonGameplayEffectContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPokemonGameplayEffectContext), 3177920620U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_PokemonAbilityTypes_h__Script_ProjectMimikyu_831753252(TEXT("/Script/ProjectMimikyu"),
	nullptr, 0,
