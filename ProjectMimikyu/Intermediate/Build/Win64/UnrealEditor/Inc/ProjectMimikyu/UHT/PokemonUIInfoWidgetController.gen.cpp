...
void FOnAttributeChangedSignature_DelegateWrapper(const FMulticastScriptDelegate& OnAttributeChangedSignature, float NewValue)
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_UI_WidgetController_PokemonUIInfoWidgetController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPokemonUIInfoWidgetController, UPokemonUIInfoWidgetController::StaticClass, TEXT("UPokemonUIInfoWidgetController"), &Z_Registration_Info_UClass_UPokemonUIInfoWidgetController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPokemonUIInfoWidgetController), 935683057U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_UI_WidgetController_PokemonUIInfoWidgetController_h_2093232042(TEXT("/Script/ProjectMimikyu"),
