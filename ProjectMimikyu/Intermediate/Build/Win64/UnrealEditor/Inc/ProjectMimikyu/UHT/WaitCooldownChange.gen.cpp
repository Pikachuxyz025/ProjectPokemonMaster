...
struct Z_Construct_UClass_UWaitCooldownChange_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UWaitCooldownChange_EndTask, "EndTask" }, // 1244108086
		{ &Z_Construct_UFunction_UWaitCooldownChange_WaitForCooldownChange, "WaitForCooldownChange" }, // 1820151053
	};
...
struct Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_AbilitySystem_AsyncTasks_WaitCooldownChange_h__Script_ProjectMimikyu_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWaitCooldownChange, UWaitCooldownChange::StaticClass, TEXT("UWaitCooldownChange"), &Z_Registration_Info_UClass_UWaitCooldownChange, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaitCooldownChange), 3908907905U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_AbilitySystem_AsyncTasks_WaitCooldownChange_h__Script_ProjectMimikyu_2072895071(TEXT("/Script/ProjectMimikyu"),
