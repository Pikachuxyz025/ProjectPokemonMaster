...
DEFINE_VTABLE_PTR_HELPER_CTOR(UEnvQueryContext_ThreatImpacts);
...
struct Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_EQS_Context_EnvQueryContext_ThreatImpacts_h__Script_ProjectMimikyu_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryContext_ThreatImpacts, UEnvQueryContext_ThreatImpacts::StaticClass, TEXT("UEnvQueryContext_ThreatImpacts"), &Z_Registration_Info_UClass_UEnvQueryContext_ThreatImpacts, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryContext_ThreatImpacts), 2754206232U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1351d_OneDrive_Documents_GitHub_ProjectPokemonMaster_ProjectMimikyu_Source_ProjectMimikyu_Public_EQS_Context_EnvQueryContext_ThreatImpacts_h__Script_ProjectMimikyu_2140317451(TEXT("/Script/ProjectMimikyu"),
